...
//           <SkillBar title="SEO Optimization" percent="80%" />
//           <SkillBar title="Social Media Marketing" percent="80%" />
//           <SkillBar title="Content Marketing" percent="80%" />
    ...
    <div className="overflow-x-hidden">
      ...
      <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2 relative">
        <motion.span
          ...
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.5 }}
          style={{ width: percent }} // ✅ Inline style fixes Tailwind limitation
          className="h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative"
        >
          <span className="absolute -top-7 right-0 text-sm font-semibold">
            {percent}
          </span>
        </motion.span>
      </span>
